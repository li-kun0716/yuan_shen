<template>
    <div class="my-post-upload">
        <header>
            <span class="active">我的发帖</span>
        </header>

        <div class="content">
            <div class="content-item" v-for="item in myUploadPostList" :key="item.postId"
        ...
        <NoDataVue v-if="myUploadPostList.length == 0"></NoDataVue>
    </div>
</template>
...
const myUploadPostList = computed(() => _store.state.post.myUploadPostList)
const userAccount = useUserAccount()
const _store = useStore()
const getUserUploadPostByUserAccount = () => {
    if (userAccount.value) {
        _store.dispatch('post/getPostByUserAccount', userAccount.value)
    }
}
getUserUploadPostByUserAccount()
